...
class TopupServiceImplTest {
    ...
    @BeforeEach
    void setup() {
        topup = new Topup("01", LocalDateTime.now(),new User("01", "tika@gmail.com", "082165417356", "tika", "jakarta", Date.valueOf("1999-10-10"),1,0,0), new TopupDetail());
    }
    ...
    void getAllTopUp() {
        ...
        Topup topup = new Topup("01", LocalDateTime.now(),new User("01", "tika@gmail.com", "082165417356", "tika", "jakarta", Date.valueOf("1999-10-10"),1,0,0), new TopupDetail());
        Topup topup1 = new Topup("02", LocalDateTime.now(),new User("01", "tika@gmail.com", "082165417356", "tika", "jakarta", Date.valueOf("1999-10-10"),1,0,0), new TopupDetail());
