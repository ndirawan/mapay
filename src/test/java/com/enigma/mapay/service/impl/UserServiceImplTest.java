...
class UserServiceImplTest {
    ...
    @BeforeEach
    void setup() {
        user = new User("01", "tika@gmail.com", "082165417356", "tika", "jakarta", Date.valueOf("1999-10-10"),1,0,0);
    }
    ...
    @Test
    void saveUser() {
        User user = new User("01", "tika@gmail.com", "082165417356", "tika", "jakarta", Date.valueOf("1999-10-10"),1,0,0);
    ...
    void getAllUser() {
        ...
        User user = new User("01", "tika@gmail.com", "082165417356", "tika", "jakarta", Date.valueOf("1999-10-10"),1,0,0);
        User user1 = new User("02", "diana@gmail.com", "082165417390", "diana", "jakarta", Date.valueOf("1999-10-10"),1,0,0);
        listOfUser.add(user);
